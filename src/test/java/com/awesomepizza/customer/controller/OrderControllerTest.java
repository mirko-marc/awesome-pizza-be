...
import com.awesomepizza.customer.mapper.OrderApiMapperImpl;
...
class OrderControllerTest {
    ...
    void returnsNotFoundWhenMonitoringAnUnknownOrder() throws Exception {
        ...
        when(orderService.monitorOrder(code)).thenThrow(new OrderNotFoundException(code));
    ...
    private OrderModel order() {
        PizzaModel pizza = PizzaModel.builder()
                .id(1L)
                .name("Margherita")
